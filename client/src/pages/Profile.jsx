...
//FIX THE PROFILE IMAGE NOT SHOWING UP WHEN THE USER IS UPDATED
const Profile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    street: "",
    zipcode: "",
    avatar: assets.profile_icon, // Default profile icon
  });
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      avatar: userData.avatar || assets.profile_icon, // Use default if no avatar
    });
  }, [userData]);
...
// const Profile = () => {
//   const { userData, backendUrl, getUserData } = useContext(ShopContext);
//   const [formData, setFormData] = useState({
//     name: userData.name || "",
//     email: userData.email || "",
//     phone: userData.phone || "",
